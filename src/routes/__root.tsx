...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Skin Grocer — Authentic Korean Skincare, Delivered Next-Day in Australia" },
      { name: "description", content: "Australian-owned skincare destination for authentic K-beauty and premium imports. Next-day delivery, locally stocked, expertly guided." },
      { name: "author", content: "Skin Grocer" },
      { property: "og:title", content: "Skin Grocer — Authentic Korean Skincare in Australia" },
      { property: "og:description", content: "Authentic, clean and affordable Korean skincare with next-day delivery across Australia." },
