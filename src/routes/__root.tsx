...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Skin Grocer — Authentic Korean Skincare, Next-Day from Melbourne" },
      { name: "twitter:description", content: "Melbourne's destination for authentic K-beauty and premium imports. Locally stocked, expertly guided, dispatched next-day across Australia." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/gwAaOXihtTTGgkEaOKEPWaclwS23/social-images/social-1784705961967-hf_20260721_011553_e0d5b100-374e-4eb3-a3e3-9303ef469a0d.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/gwAaOXihtTTGgkEaOKEPWaclwS23/social-images/social-1784705961967-hf_20260721_011553_e0d5b100-374e-4eb3-a3e3-9303ef469a0d.webp" },
    ],
    links: [
