...
export const Route = createFileRoute('/club')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Earn points on every order, subscribe to restock your routine, and unlock Circle for 2x points and early access to new brand drops.' },
