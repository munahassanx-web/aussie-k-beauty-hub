...
export const newsletterIssues: NewsletterIssue[] = [
  ...
  },
  {
    ...
    everyone: {
      ...
      image: hypeScrutiny,
      imageAlt: "An unbranded serum bottle examined under a magnifying glass on a pale surface",
      body: [
  ...
  },
  {
    ...
    everyone: {
      ...
      image: matureSkin,
      imageAlt: "Portrait of a woman in her forties with bare, healthy skin and natural texture in soft daylight",
      body: [
