...
export type Category = "Cleanse" | "Tone" | "Treat" | "Moisturise" | "Protect" | "Masks" | "Multi-step trial routine";
...
export const SHOP_PRODUCTS: ShopProduct[] = [
  ...
  { name: "1025 Dokdo Trial Kit (Cleanser 30ml + Toner 20ml + Ampule 10ml + Cream 20ml)", brand: "ROUND LAB", price: "$30", priceId: "round_lab_1025_dokdo_trial_kit_onetime", size: "Cleanser 30ml + Toner 20ml + Ampoule 10ml + Cream 20ml", tag: null, category: "Multi-step trial routine", image: "/products/round-lab/1025-dokdo-trial-kit.webp", concerns: ["pigmentation"] },
  ...
  { name: "Balanceful Trial Kit (Global)", brand: "TORRIDEN", price: "$35", priceId: "torriden_balanceful_trial_kit_onetime", size: "Cleansing Gel 30ml + Toner Pads 6 pads + Serum 10ml + Cream 20ml", tag: null, category: "Multi-step trial routine", image: "/products/torriden/balanceful-trial-kit.webp", concerns: ["barrier"] },
  { name: "Dive In Trial Kit (Global)", brand: "TORRIDEN", price: "$35", priceId: "torriden_dive_in_trial_kit_onetime", size: "Cleansing Foam 30ml + Toner 50ml + Serum 20ml + Cream 20ml", tag: null, category: "Multi-step trial routine", image: "/products/torriden/dive-in-trial-kit.webp", concerns: ["hydration"] },
  ...
  // UMMA
  {
    ...
    // Separate identifier from the brand's "Rose PDRN Soothing Serum". The two
    // are distinct products: never merge formula, description, image or source.
    ...
    category: "Treat",
    productType: "retinal evening serum",
    routineStep: "treat",
    temporaryProductTypeLabel: "retinal evening serum",
    ...
    verifiedUsageDirections:
      "In the evening, apply an appropriate amount after cleansing and toner. Avoid the immediate eye and mouth areas, then gently pat until absorbed.",
    verifiedUsageNotes: [
      "Evening use only.",
      "Introduce gradually rather than beginning with nightly use.",
      "Use a broad-spectrum sunscreen during the day.",
      "Do not combine in the same routine with another retinoid.",
      "Customers using strong exfoliating acids may prefer to alternate nights.",
      "Avoid during pregnancy or breastfeeding, following the brand's guidance.",
      "The naturally yellow formula may temporarily mark skin or light fabrics. Allow it to absorb fully.",
      "Patch test before use and stop if irritation occurs.",
    ],
    inci: [
      "Water",
      "Dicaprylyl Carbonate",
  ...
  },
  {
    ...
    category: "Treat",
    productType: "tone-focused serum",
    routineStep: "treat",
    temporaryProductTypeLabel: "tone-focused serum",
    verifiedTemporaryDescription:
    ...
    verifiedUsageDirections:
      "After cleansing and toner, apply a moderate amount and gently pat or massage until absorbed. The brand directs that it may be used in morning or evening routines.",
    verifiedUsageNotes: [
    ...
    inci: [
      ...
      "Polyglyceryl-10 Laurate",
      "Madecassoside (30ppm)",
      "Centella Asiatica Extract (25ppm)",
      "Asiaticoside (20ppm)",
      "Ascorbic Acid",
      "Asiatic Acid (2ppm)",
      "Madecassic Acid (2ppm)",
  ...
  { ...CONTENT_IN_PREPARATION, name: "Radiant Vita Niacinamide Real Deep Mask", brand: "BIODANCE", priceId: "biodance_radiant_vita_niacinamide_real_deep_mask_onetime", category: "Masks",
    productType: "mask",
    routineStep: "masks",
    temporaryProductTypeLabel: "mask", size: "1 box (4 \u00d7 34g masks)", routineStepLabelOverride: "Weekly Treatment", supplierReconciliationStatus: "matched_seoul4pm",
    verifiedTemporaryDescription:
      "A two-piece hydrogel mask formulated with pineapple fruit water, niacinamide, betaine, allantoin, glutathione and multiple forms of hyaluronic acid.",
    verifiedUsageOptions: [
      {
        label: "Daytime",
        text: "After toner or serum, apply both sections of the mask to the face. Leave on for 3\u20134 hours, or until the hydrogel becomes transparent, then remove.",
      },
      {
        label: "Overnight",
        text: "Apply as the final step of the evening skincare routine. Leave on overnight and remove the following morning.",
      },
    ],
    verifiedUsageNotes: [
      ...
      "Stop use if persistent redness, swelling, itching or discomfort occurs.",
      "Do not reuse the mask.",
      "Store away from direct sunlight and out of reach of children.",
    ],
    internalClaimRestrictions: [
      "Do not claim the mask treats melasma or hyperpigmentation.",
      "Do not claim it corrects dark spots.",
      "Do not claim it tightens pores.",
      "Do not claim it penetrates deeply into the skin.",
      "Do not claim it delivers collagen into the skin.",
      "Do not claim hydration for 150 hours or a 166% hydration increase.",
      "Do not describe it as hypoallergenic, allergen-free or non-toxic.",
      "Do not claim it is safe for every skin type or during pregnancy or breastfeeding.",
      "Do not guarantee brightening, firming or redness results.",
      "Do not claim clinically proven benefits without a reviewed supporting study.",
    ],
    inci: [
      "Water",
    ...
    inciSource: "brand",
    inciSourceName: "BIODANCE official product page",
    inciSourceUrl: "https://biodance.com/products/radiant-vita-niacinamide-real-deep-mask",
    inciCheckedOn: "2026-09-12",
    ingredientReviewStatus: "reviewed",
    identityVerificationStatus: "online_identity_supported",
    identitySources: [
      {
        sourceType: "official_brand",
        sourceName: "BIODANCE",
        sourceUrl: "https://biodance.com/products/radiant-vita-niacinamide-real-deep-mask",
  ...
  { ...CONTENT_IN_PREPARATION, name: "Collagen Mask to Foam Cleanser 150ml", brand: "BIODANCE", priceId: "biodance_collagen_mask_to_foam_cleanser_150ml_onetime", category: "Cleanse",
    ...
    routineStep: "cleanse",
    temporaryProductTypeLabel: "cleanser", size: "150ml", routineStepLabelOverride: "Step 1 \u2014 Cleanse", supplierReconciliationStatus: "matched_seoul4pm",
    verifiedTemporaryDescription:
      "A rinse-off cleanser with a dense, stretchy texture that can be used as a daily foaming cleanser or as a short-contact cleansing mask. The formula contains glycerin, mild surfactants, niacinamide, kaolin, botanical extracts and hydrolysed hyaluronic acid.",
    verifiedUsageOptions: [
      {
        label: "As a daily foam cleanser",
        text: "Lather a coin-sized amount with water. Massage the foam gently onto damp skin for up to 60 seconds, avoiding the eye area, then rinse thoroughly with lukewarm water.",
      },
      {
        label: "As a short-contact cleansing mask",
        text: "Apply a thin, even layer to dry skin, avoiding the eyes and lips. Leave on for 1\u20133 minutes. Wet the hands, massage gently to create a foam, then rinse thoroughly with lukewarm water.",
      },
    ],
    verifiedUsageDirections:
    ...
    verifiedUsageNotes: [
      ...
      "If skin feels dry or tight, reduce the frequency or contact time.",
      "Store away from direct sunlight and out of reach of children.",
    ],
    internalClaimRestrictions: [
      "Do not claim the cleanser unclogs, shrinks or tightens pores.",
      "Do not claim it treats acne.",
      "Do not claim it removes all makeup or water-resistant sunscreen by itself.",
      "Do not claim it delivers collagen deeply into the skin.",
      "Do not claim it restores elasticity or provides clinical firming.",
      "Do not describe it as irritation-free or suitable for every person or skin type.",
      "Do not claim it is pregnancy-safe.",
    ...
    inciSource: "brand",
    inciSourceName: "BIODANCE official product page",
    inciSourceUrl: "https://biodance.com/products/collagen-mask-to-foam-cleanser",
    inciCheckedOn: "2026-09-12",
    ingredientReviewStatus: "reviewed",
    identityVerificationStatus: "online_identity_supported",
    identitySources: [
      {
        sourceType: "official_brand",
        sourceName: "BIODANCE",
        sourceUrl: "https://biodance.com/products/collagen-mask-to-foam-cleanser",
        sourceReviewedDate: "2026-09-12",
        sourceVerificationStatus: "online_reference_reviewed",
      },
    ] },
  { ...CONTENT_IN_PREPARATION, name: "Skin Glow Essence Cream 50ml", brand: "BIODANCE", priceId: "biodance_skin_glow_essence_cream_50ml_onetime", category: "Moisturise",
    ...
    verifiedUsageDirections:
      "Apply after toner and treatment products. Gently spread an appropriate amount over the face and pat until absorbed.",
    verifiedUsageNotes: [
      "Patch test before use.",
      "Avoid direct contact with the eyes.",
      "Stop use if irritation occurs.",
    ...
    internalClaimRestrictions: [
      "Do not claim it penetrates deeply.",
      "Do not claim it boosts the microbiome.",
      "Do not claim it protects against bacteria or toxins.",
      "Do not describe it as hypoallergenic or safe for every skin type.",
      "Do not guarantee glass skin.",
      "Do not claim it treats acne or a damaged skin barrier.",
    ],
    inci: [
      "Water",
      "Hydrogenated Polydecene",
    ...
    inciSource: "brand",
    inciSourceName: "BIODANCE official product page",
    inciSourceUrl: "https://biodance.com/products/biodance-skin-glow-essence-cream-50ml",
    inciCheckedOn: "2026-09-12",
    ingredientReviewStatus: "reviewed",
    identityVerificationStatus: "online_identity_supported",
    identitySources: [
      {
        sourceType: "official_brand",
        sourceName: "BIODANCE",
        sourceUrl: "https://biodance.com/products/biodance-skin-glow-essence-cream-50ml",
        sourceReviewedDate: "2026-09-12",
        sourceVerificationStatus: "online_reference_reviewed",
      },
    ] },
  ...
  { ...CONTENT_IN_PREPARATION, name: "Probioderm 3D Lifting Cream 50ml", brand: "BIOHEAL BOH", priceId: "bioheal_boh_probioderm_3d_lifting_cream_50ml_onetime", category: "Moisturise", size: "50ml",
    ...
    verifiedUsageNotes: ["For external use only.", "Avoid direct contact with the eyes.", "Do not apply to broken or irritated skin.", "Patch test before first use.", "Introduce cautiously if already using exfoliating acids or retinoids.", "Stop use if persistent irritation occurs.", "Store away from direct sunlight and out of reach of children."],
  ...
  {
    ...CONTENT_IN_PREPARATION,
    // Retinol 0.08% — distinct from the Rose PDRN Firming Serum (retinal 0.1%).
    // Concentrations and pregnancy guidance must never transfer between them.
    ...
    category: "Treat",
    productType: "retinol evening serum",
    routineStep: "treat",
    temporaryProductTypeLabel: "retinol evening serum",
    verifiedTemporaryDescription:
      "An unscented evening serum formulated with 0.08% retinol, bakuchiol, sunflower seed oil, fermented rice extract and ceramide NP.",
    verifiedUsageDirections:
      "At night, apply approximately a pea-sized amount after cleansing and toner, avoiding the immediate eye and mouth areas. Begin once or twice weekly and increase gradually only if your skin tolerates it.",
    verifiedUsageNotes: [
      "Evening use only.",
      "Introduce gradually.",
      "Use broad-spectrum sunscreen and sun-protective measures during the day.",
      "Do not use in the same routine as another retinoid.",
      "Avoid combining in the same routine with AHA, BHA or PHA exfoliants.",
      "The brand advises avoiding concurrent high-strength copper peptides or strong vitamin C products.",
      "Avoid during pregnancy or breastfeeding, following the brand's guidance.",
      "For external use only.",
      "Patch test before use.",
      "Stop use if significant or persistent irritation occurs.",
    ...
    inci: [
      ...
      "Arginine",
      "Acrylates/C10-30 Alkyl Acrylate Crosspolymer",
      "Phyllostachys Pubescens Shoot Bark Extract (1,000ppm)",
      "Disodium EDTA",
      "Retinol (0.08%)",
      "Aspergillus Ferment",
      "Ethylhexylglycerin",
  ...
  },
  {
    ...
    temporaryProductTypeLabel: "moisturiser",
    verifiedTemporaryDescription:
      "A moisturising cream formulated with squalane, caffeine, soy and pea proteins, Centella components, ceramide NP and five peptides.",
    verifiedUsageDirections:
      "Apply evenly after toner and treatment products, then gently pat or massage until absorbed.",
    verifiedUsageNotes: [
      "Patch test before use.",
      "Avoid direct contact with the eyes.",
      "Stop use if irritation occurs.",
  ...
  },
  {
    ...
    routineStep: "moisturise",
    routineStepLabelOverride: "Optional — Eye care",
    temporaryProductTypeLabel: "eye cream",
    verifiedTemporaryDescription:
      "An unscented eye-area moisturiser formulated with bakuchiol, niacinamide, sunflower seed oil, fermented rice extract, adenosine, sodium hyaluronate and madecassoside.",
    verifiedUsageDirections:
      "After moisturising, apply a small amount around the orbital area and gently pat until absorbed. Keep the product away from the eyes and lash line.",
    verifiedUsageNotes: [
