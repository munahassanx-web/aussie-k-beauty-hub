...
export const SHOP_PRODUCTS: ShopProduct[] = [
  ...
  { name: "PDRN Pink Cica Soothing Toner 250ml", brand: "MEDICUBE", price: "$36", priceId: "medicube_pdrn_pink_cica_soothing_toner_250ml_onetime", tag: null, category: "Tone", image: "/products/medicube/pdrn-pink-cica-soothing-toner-250ml.webp", concerns: ["sensitivity","anti-aging","pigmentation"] },
  ...
  { name: "Mung Bean pH-Balanced Cleansing Foam 80ml", brand: "beplain", price: "$24", priceId: "beplain_mung_bean_ph_balanced_cleansing_foam_80ml_onetime", tag: null, category: "Cleanse", image: "/products/beplain/mung-bean-ph-balanced-cleansing-foam-80ml.webp", concerns: ["sensitivity"] },
  ...
  { name: "1025 Dokdo Toner + Lotion Special Set (200ml + 200ml)", brand: "ROUND LAB", price: "$45", priceId: "round_lab_1025_dokdo_toner_plus_lotion_special_set_onetime", tag: null, category: "Tone", image: "/products/round-lab/1025-dokdo-toner-plus-lotion-special-set.webp", concerns: ["hydration","pigmentation"] },
  { name: "Birch Juice Moisturizing Cream 80ml", brand: "ROUND LAB", price: "$35", priceId: "round_lab_birch_juice_moisturizing_cream_80ml_onetime", tag: null, category: "Moisturise", image: "/products/round-lab/birch-juice-moisturizing-cream-80ml.webp", concerns: ["hydration","barrier"] },
  { name: "1025 Dokdo Trial Kit (Cleanser 30ml + Toner 20ml + Ampule 10ml + Cream 20ml)", brand: "ROUND LAB", price: "$30", priceId: "round_lab_1025_dokdo_trial_kit_onetime", tag: null, category: "Treat", image: "/products/round-lab/1025-dokdo-trial-kit.webp", concerns: ["pigmentation"] },
  ...
  { name: "Green Tea Fresh Toner 200ml", brand: "ISNTREE", price: "$26", priceId: "isntree_green_tea_fresh_toner_200ml_onetime", tag: null, category: "Tone", image: "/products/isntree/green-tea-fresh-toner-200ml.webp", concerns: ["sensitivity","pigmentation"] },
  ...
  { name: "Black Rice Hyaluronic Toner 150ml", brand: "HARUHARU WONDER", price: "$28", priceId: "haruharu_wonder_black_rice_hyaluronic_toner_150ml_onetime", tag: null, category: "Tone", image: "/products/haruharu-wonder/black-rice-hyaluronic-toner-150ml.webp", concerns: ["hydration","pigmentation"] },
  ...
  { name: "Dive In Serum", brand: "TORRIDEN", price: "$38", priceId: "torriden_dive_in_serum_onetime", tag: null, category: "Treat", image: "/products/torriden/dive-in-serum.webp", concerns: ["hydration"] },
  { name: "Dive In Soothing Cream", brand: "TORRIDEN", price: "$40", priceId: "torriden_dive_in_soothing_cream_onetime", tag: null, category: "Moisturise", image: "/products/torriden/dive-in-soothing-cream.webp", concerns: ["hydration","sensitivity"] },
  { name: "Balanceful Cleansing Gel", brand: "TORRIDEN", price: "$34", priceId: "torriden_balanceful_cleansing_gel_onetime", tag: null, category: "Cleanse", image: "/products/torriden/balanceful-cleansing-gel.webp", concerns: ["barrier"] },
  { name: "Dive In Mask Pack 1pc", brand: "TORRIDEN", price: "$10", priceId: "torriden_dive_in_mask_pack_1pc_onetime", tag: null, category: "Masks", image: "/products/torriden/dive-in-mask-pack-1pc.webp", concerns: ["hydration"] },
  { name: "Balanceful Trial Kit (Global)", brand: "TORRIDEN", price: "$35", priceId: "torriden_balanceful_trial_kit_onetime", tag: null, category: "Treat", image: "/products/torriden/balanceful-trial-kit.webp", concerns: ["barrier"] },
  { name: "Dive In Trial Kit (Global)", brand: "TORRIDEN", price: "$35", priceId: "torriden_dive_in_trial_kit_onetime", tag: null, category: "Treat", image: "/products/torriden/dive-in-trial-kit.webp", concerns: ["hydration"] },
  { name: "Refreshing Sea Kelp Real Deep Mask", brand: "BIODANCE", price: "$38", priceId: "biodance_refreshing_sea_kelp_real_deep_mask_onetime", tag: null, category: "Masks", image: "/products/biodance/refreshing-sea-kelp-real-deep-mask.webp", concerns: ["sensitivity"] },
  { name: "Bio Collagen Real Deep Mask", brand: "BIODANCE", price: "$38", priceId: "biodance_bio_collagen_real_deep_mask_onetime", tag: null, category: "Masks", image: "/products/biodance/bio-collagen-real-deep-mask.webp", concerns: ["barrier","anti-aging"] },
  { name: "Hydro Cera-Nol Real Deep Mask", brand: "BIODANCE", price: "$38", priceId: "biodance_hydro_cera_nol_real_deep_mask_onetime", tag: null, category: "Masks", image: "/products/biodance/hydro-cera-nol-real-deep-mask.webp", concerns: ["hydration","barrier"] },
  ...
  { name: "Atobarrier365 Cream (2nd Generation)", brand: "AESTURA", price: "$55", priceId: "aestura_atobarrier365_cream_onetime", tag: null, category: "Moisturise", image: "/products/aestura/atobarrier365-cream.webp", concerns: ["sensitivity","barrier"] },
  { name: "Derma UV365 Barrier Moisture Mineral Sun Cream 20ml", brand: "AESTURA", price: "$10", priceId: "aestura_derma_uv365_barrier_moisture_mineral_sun_cream_onetime", tag: null, category: "Protect", image: "/products/aestura/derma-uv365-barrier-moisture-mineral-sun-cream.webp", concerns: ["hydration","barrier","pigmentation"] },
  ...
  { name: "Atobarrier 365 Hydro Soothing Cream", brand: "AESTURA", price: "$60", priceId: "aestura_atobarrier_365_hydro_soothing_cream_onetime", tag: null, category: "Moisturise", image: "/products/aestura/atobarrier-365-hydro-soothing-cream.webp", concerns: ["hydration","sensitivity","barrier"] },
  { name: "Aqua Oasis Toner", brand: "S.NATURE", price: "$40", priceId: "s_nature_aqua_oasis_toner_onetime", tag: null, category: "Tone", image: "/products/s-nature/aqua-oasis-toner.webp", concerns: ["hydration","pigmentation"] },
  { name: "Aqua Squalane Serum", brand: "S.NATURE", price: "$34", priceId: "s_nature_aqua_squalane_serum_onetime", tag: null, category: "Treat", image: "/products/s-nature/aqua-squalane-serum.webp", concerns: ["hydration"] },
  { name: "Aqua Squalane Moisturizing Cream", brand: "S.NATURE", price: "$35", priceId: "s_nature_aqua_squalane_moisturizing_cream_onetime", tag: null, category: "Moisturise", image: "/products/s-nature/aqua-squalane-moisturizing-cream.webp", concerns: ["hydration"] },
  { name: "Aqua Oasis Moisturizing Gel", brand: "S.NATURE", price: "$40", priceId: "s_nature_aqua_oasis_moisturizing_gel_onetime", tag: null, category: "Moisturise", image: "/products/s-nature/aqua-oasis-moisturizing-gel.webp", concerns: ["hydration"] },
  { name: "Aqua Soy Yogurt Eye Cream", brand: "S.NATURE", price: "$35", priceId: "s_nature_aqua_soy_yogurt_eye_cream_onetime", tag: null, category: "Moisturise", image: "/products/s-nature/aqua-soy-yogurt-eye-cream.webp", concerns: ["hydration","anti-aging"] },
  { name: "Mung Bean Pore Tight-Up Soothing Cream", brand: "beplain", price: "$28", priceId: "beplain_mung_bean_pore_tight_up_soothing_cream_onetime", tag: null, category: "Moisturise", image: "/products/beplain/mung-bean-pore-tight-up-soothing-cream.webp", concerns: ["acne","sensitivity"] },
  { name: "Milk Ceramide Moisturizing Cream", brand: "beplain", price: "$35", priceId: "beplain_milk_ceramide_moisturizing_cream_onetime", tag: null, category: "Moisturise", image: "/products/beplain/milk-ceramide-moisturizing-cream.webp", concerns: ["hydration","barrier"] },
  { name: "Ginseng Cleansing Oil 210ml", brand: "Beauty of Joseon", price: "$30", priceId: "beauty_of_joseon_ginseng_cleansing_oil_210ml_onetime", tag: "New", category: "Cleanse", image: "/__l5e/assets-v1/6c52862d-3e5c-40b9-b5b7-38a4deb41579/boj-ginseng-cleansing-oil.png", concerns: ["hydration"] },
  ...
  { name: "Glow Serum: Propolis + Niacinamide 30ml", brand: "Beauty of Joseon", price: "$34", priceId: "beauty_of_joseon_glow_serum_propolis_plus_niacinamide_30ml_onetime", tag: "New", category: "Treat", image: "/__l5e/assets-v1/d5d743cf-0c9b-4181-8715-2aa3dc4426c3/boj-glow-serum-propolis.png", concerns: ["hydration","pigmentation"] },
  { name: "Dynasty Cream 50ml", brand: "Beauty of Joseon", price: "$36", priceId: "beauty_of_joseon_dynasty_cream_50ml_onetime", tag: "New", category: "Moisturise", image: "/products/beauty-of-joseon/dynasty-cream-50ml.webp", concerns: ["hydration","barrier"] },
