...
export const SHOP_PRODUCTS: ShopProduct[] = [
  ...
  { name: "Ginseng Cleansing Oil 210ml", brand: "Beauty of Joseon", price: "$30", priceId: "beauty_of_joseon_ginseng_cleansing_oil_210ml_onetime", tag: "Coming soon", category: "Cleanse", image: "/products/placeholder.png", concerns: ["hydration"], comingSoon: true },
  { name: "Green Plum Refreshing Toner: AHA + BHA 150ml", brand: "Beauty of Joseon", price: "$32", priceId: "beauty_of_joseon_green_plum_refreshing_toner_150ml_onetime", tag: "Coming soon", category: "Tone", image: "/products/placeholder.png", concerns: ["acne"], comingSoon: true },
  ...
  { name: "Dynasty Cream 50ml", brand: "Beauty of Joseon", price: "$36", priceId: "beauty_of_joseon_dynasty_cream_50ml_onetime", tag: "Coming soon", category: "Moisturise", image: "/products/placeholder.png", concerns: ["hydration","barrier"], comingSoon: true },
];
