...
export const SHOP_PRODUCTS: ShopProduct[] = [
  ...
  { name: "Derma UV365 Barrier Moisture Mineral Sun Cream 20ml", brand: "AESTURA", price: "$10", priceId: "aestura_derma_uv365_barrier_moisture_mineral_sun_cream_onetime", tag: null, category: "Protect", image: "/products/aestura/derma-uv365-barrier-moisture-mineral-sun-cream.png", concerns: ["hydration","barrier","pigmentation"] },
  { name: "A-Cica Moisture Toner 25ml", brand: "AESTURA", price: "$10", priceId: "aestura_a_cica_moisture_toner_onetime", tag: null, category: "Tone", image: "/products/aestura/a-cica-moisture-toner.png", concerns: ["hydration","sensitivity","pigmentation"] },
  ...
  { name: "Green Plum Refreshing Toner: AHA + BHA 150ml", brand: "Beauty of Joseon", price: "$32", priceId: "beauty_of_joseon_green_plum_refreshing_toner_150ml_onetime", tag: "New", category: "Tone", image: "/products/beauty-of-joseon/green-plum-refreshing-toner-aha-bha-150ml.png", concerns: ["acne"] },
  ...
  { name: "Dynasty Cream 50ml", brand: "Beauty of Joseon", price: "$36", priceId: "beauty_of_joseon_dynasty_cream_50ml_onetime", tag: "New", category: "Moisturise", image: "/products/beauty-of-joseon/dynasty-cream-50ml.png", concerns: ["hydration","barrier"] },
...
export const BUNDLE_DEFINITIONS: BundleDefinition[] = [
  {
    ...
    products: [
      ...
      { img: "/products/torriden/dive-in-soothing-cream.png", alt: "TORRIDEN Dive In Soothing Cream" },
    ],
    price: 98,
    featured: false,
  },
