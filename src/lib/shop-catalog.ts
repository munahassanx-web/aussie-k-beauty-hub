...
export const SHOP_PRODUCTS: ShopProduct[] = [
  ...
  { name: "Dive In Soothing Cream", brand: "TORRIDEN", price: "$40", priceId: "torriden_dive_in_soothing_cream_onetime", size: "100ml", tag: null, category: "Moisturise", image: "/products/torriden/dive-in-soothing-cream.webp", concerns: ["hydration","sensitivity"] },
  { name: "Balanceful Cleansing Gel", brand: "TORRIDEN", price: "$34", priceId: "torriden_balanceful_cleansing_gel_onetime", size: "200ml", tag: null, category: "Cleanse", image: "/products/torriden/balanceful-cleansing-gel.webp", concerns: ["barrier"] },
  ...
  { name: "Atobarrier365 Cream (2nd Generation)", brand: "AESTURA", price: "$55", priceId: "aestura_atobarrier365_cream_onetime", size: "80ml", tag: null, category: "Moisturise", image: "/products/aestura/atobarrier365-cream.webp", concerns: ["sensitivity","barrier"] },
  ...
  { name: "Milk Ceramide Moisturizing Cream", brand: "beplain", price: "$35", priceId: "beplain_milk_ceramide_moisturizing_cream_onetime", size: "50ml", tag: null, category: "Moisturise", image: "/products/beplain/milk-ceramide-moisturizing-cream.webp", concerns: ["hydration","barrier"] },
