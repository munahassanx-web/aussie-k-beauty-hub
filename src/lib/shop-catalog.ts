...
export const SHOP_PRODUCTS: ShopProduct[] = [
  ...
  { name: "Bio Collagen Real Deep Mask", brand: "BIODANCE", price: "$38", priceId: "biodance_bio_collagen_real_deep_mask_onetime", size: "4 sheets", tag: null, category: "Masks", image: "/products/biodance/bio-collagen-real-deep-mask.webp", concerns: ["barrier","anti-aging"] },
