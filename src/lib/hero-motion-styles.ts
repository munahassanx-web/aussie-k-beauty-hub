...
export const HERO_MOTION_STYLES: HeroMotionStyle[] = [
  {
    id: "smash",
    label: "Smash",
    blurb: "Hurtles in oversized and slams down with shockwaves and debris.",
    product: {
      initial: { opacity: 0, scale: 2.6, filter: "blur(26px)", rotate: 18, y: -140 },
      animate: { opacity: 1, scale: 1, filter: "blur(0px)", rotate: 0, y: 0 },
      exit: { opacity: 0, scale: 1.45, filter: "blur(18px)", rotate: 10, y: -70 },
    ...
    flash: { enabled: true, from: 0.95, to: 1.5, duration: 0.5 },
    waves: { count: 2, scale: 3.4, duration: 0.85, stagger: 0.12 },
    shards: { count: 14, dist: 130, duration: 0.9, gravity: 40 },
  },
  {
    id: "drop",
    label: "Drop",
